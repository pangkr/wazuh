...
@pytest.mark.parametrize('param_value', [
    ...
    # all_msg, some_msg, none_msg
    [['001', '002'], 2, param_name, ['int'], [True], 'Sample message', 'Sample message', 'Sample message'],
    [['001', '003'], None, param_name, ['int'], [True, False, True], 'Sample message', 'Sample message', 'Sample message'],
    [[], 0, None, ['int'], [True, False, True], 'Sample message', 'Sample message', 'Sample message'],
...
def test_result_exceptions(or_type, expected_result):
...
def test_result_nested_itemgetter(item, expressions, expected_result):
...
def test_result__goes_before_than(a, b, ascending, casters, expected_result):
